...
const SORT = {
  'trending-desc': 'Tendencias',
  'latest-desc': 'Ultimos ingresados',
  'price-asc': 'Precio: Mas barato a mas caro',
  'price-desc': 'Precio: mas caro a mas barato',
}
              ...
              {data ? (
                <>
                  ...
                  >
                    {q ? (
                      <>
                        No hay productos que coincidan con "<strong>{q}</strong>"
                      </>
                    ) : (
                      <>
                        No hay productos en la categoria seleccionada
                      </>
                    )}
                  </span>
                </>
